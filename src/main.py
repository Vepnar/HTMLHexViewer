...
def read_binary(path: str, offset=0, length=0) -> Iterator[str]:
    read_bytes = []
...
def parse_args() -> Tuple:
    ...
    parser.add_argument(
        "-o", "--output", type=argparse.FileType("w"), default="./report.html"
    )
